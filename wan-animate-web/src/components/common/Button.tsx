...
const variants: Record<Variant, string> = {
  ...
  secondary:
    'bg-white border border-morandi-border text-morandi-text hover:bg-morandi-hover hover:border-morandi-primary/40 disabled:opacity-50',
  danger: 'bg-morandi-danger text-white hover:opacity-90 disabled:opacity-50',
  ghost: 'text-morandi-muted hover:text-morandi-primary hover:bg-morandi-hover',
}
